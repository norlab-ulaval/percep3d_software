#!/bin/bash
# =================================================================================================
# Execute 'percep3d_software' repo shell script tests via 'norlab-shell-script-tools' library
#
# Usage:
...
function n2st::run_n2st_testsing_tools(){
  ...
  # ....Project root logic.........................................................................
  P3SC_ROOT=$(git rev-parse --show-toplevel)

  # ....Load environment variables from file.......................................................
  cd "${P3SC_ROOT}" || exit 1
  set -o allexport
  source .env.percep3d_software
  set +o allexport
