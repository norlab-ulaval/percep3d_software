...
echo
echo -e "Starting container \033[1;37mssh server on port ${P3D_SSH_SERVER_PORT}\033[0m with \033[1;37muser ${P3D_USER}\033[0m (default pass: ${PASSWORD})"
# sshd flag
...
echo -e "To connect remotely to the container:
    ...
    $ sftp -P ${P3D_SSH_SERVER_PORT} openssh-$(hostname -I | awk '{print $1}')
    $ scp -P ${P3D_SSH_SERVER_PORT} /path/to/foo ${P3D_USER}@$(hostname -I | awk '{print $1}'):/dest/
"
